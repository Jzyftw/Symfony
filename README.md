...
Accès à la console sous Symfony 3 :
php bin/console

Générer automatiquement une entité :
php app/console doctrine:generate:entity

Mettre à jour les entités en fonction des ajouts/modifs dans le YML de l'entité :
php app/console doctrine:generate:entities sil09VitrineBundle:NOM_DE_ENTITY

vérifier la validité du mapping YML :
php app/console doctrine:schema:validate

mise à jour la bdd :
php app/console doctrine:schema:update --force

generer un CRUD (Permet de générer les controllers et routes etc...)
